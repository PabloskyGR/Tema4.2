...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Llamamos a la función suma, y mostramos el resultado de la suma de todos los
		// valores de la tabla
		System.out.println("La suma de los números de los números de ta tabla es de: " + Suma.suma(tabla));
